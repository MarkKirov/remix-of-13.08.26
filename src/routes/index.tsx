          ...
          <div className="overflow-hidden">
            <div className="mx-4 mt-2 rounded-2xl bg-neutral-100 px-5 py-4 md:mx-8 md:px-6 md:py-5">
              {procedure.description && (
                <p className={`font-body text-[13px] leading-relaxed text-neutral-700 md:text-sm${procedure.preparations.length > 0 || procedure.device || procedure.subServices || procedure.groups ? " mb-4 border-b border-neutral-200 pb-4" : ""}`}>
                  {procedure.description}
                </p>
              )}
...
const hardwareProcedures: Procedure[] = [
  {
    ...
    description:
      "Лазерное удаление папиллом, фибром, кератом на аппарате Fotona и Электрокоагуляторе — это современный, безопасный и высокоточный метод деликатного избавления от доброкачественных новообразований.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Лазерная шлифовка рубцовой ткани на аппарате Fotona эрбиевый YAG лазер — это высокоточная и безопасная процедура контролируемого послойного обновления кожи, которая запускает интенсивные процессы регенерации и позволяет эффективно сгладить шрамы, возвращая тканям ровный, эстетичный рельеф.",
  },
  {
    ...
    description:
      "Эстетическая лазерная шлифовка на эрбиевом YAG-лазере Fotona — это премиальная процедура глубокого фракционного обновления кожи, которая эффективно стирает признаки старения, выравнивает поверхность кожи и помогает достигать эффекта «бархатной кожи».",
  },
  {
    name: "СМАС-лифтинг",
    price: "от 13 200 ₽",
  ...
  },
  {
    ...
    description:
      "Фототерапия IPL на аппарате Viora V30 — терапия, которая помогает справиться с первыми и очевидными признаками старения, а также процедура способна значительно улучшить качество кожи.",
  },
  {
  ...
  },
  {
    ...
    device: "HydraFacial",
    description:
      "Водной чистки лица на аппарате HydraFacial — это вакуумное отшелушивание ороговевших частиц кожи в совокупности с использованием мультифункциональных сывороток. Чистка производится специальными сменными насадками. Благодаря данной технологии кожа остаётся чистой, увлажнённой и напитанной надолго.",
    subServices: [
...
const estheticProcedures: Procedure[] = [
  ...
  },
  {
    ...
    preparations: [],
    description:
      "Уходы по лицу — это персонализированный комплекс профессиональных неинвазивных процедур, направленных на глубокое очищение, питание и поддержание здоровья кожи. Программы включают инновационную карбокситерапию для интенсивного насыщения клеток кислородом, а также премиальные увлажняющие процедуры, которые мгновенно стирают следы усталости, возвращая лицу безупречную свежесть, тонус и естественное сияние.",
    subServices: [
  ...
  {
    name: "Сахарная эпиляция (шугаринг)",
    price: "от 660 ₽",
    detailsLabel: "Зоны эпиляции",
    preparations: [],
    description:
      "Сахарная эпиляция (шугаринг) — деликатное удаление волос натуральной сахарной пастой. Подходит для чувствительной кожи, минимизирует раздражение и врастание волос, сохраняет гладкость на несколько недель.",
    subServices: [
      { name: "Сахарная эпиляция — над верхней губой", price: "660 ₽" },
      { name: "Сахарная эпиляция — подмышечные впадины", price: "1 050 ₽" },
      { name: "Сахарная эпиляция — живот", price: "1 050 ₽" },
      { name: "Сахарная эпиляция — руки до локтя", price: "1 050 ₽" },
      { name: "Сахарная эпиляция — руки полностью", price: "1 550 ₽" },
      { name: "Сахарная эпиляция — голени", price: "1 200 ₽" },
      { name: "Сахарная эпиляция — бёдра", price: "1 450 ₽" },
      { name: "Сахарная эпиляция — ноги полностью", price: "2 200 ₽" },
      { name: "Сахарная эпиляция — классическое бикини", price: "1 300 ₽" },
      { name: "Сахарная эпиляция — полное бикини", price: "1 450 ₽" },
    ],
    note: "Точную цену вы узнаете на первичной консультации — она бесплатна. Наш специалист подберёт подходящую услугу, рассчитает стоимость и определит нужное количество процедур. Не назначайте курс себе самостоятельно — сначала проконсультируйтесь, и мы составим ваш персональный план создания естественной красоты.",
  },
