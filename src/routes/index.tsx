...
function Index() {
  ...
  return (
    <div className="bg-neutral-950 text-white">
      ...
      {/* Lovi style reference block — prescription violet on porcelain */}
      <section
        style={{
      ...
      >
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", justifyContent: "center", marginBottom: 40 }}>
            ...
            >
              ✨ Комильфо — 17 лет медицинской косметологии
            </span>
          </div>
          ...
          <h2
            style={{
              fontFamily:
                "'ES Rebond Grotesque', 'Inter Tight', 'Manrope', ui-sans-serif, system-ui, sans-serif",
              fontSize: 48,
              lineHeight: 0.91,
          ...
          >
            Клиническая эстетика, сфокусированная вокруг вас
          </p>

          {/* Voice bar (signature gradient) */}
          <div style={{ display: "flex", justifyContent: "center", marginTop: 48 }}>
            <div
              style={{
                ...
                padding: "14px 20px",
                background:
                  "linear-gradient(270deg, rgba(102,127,255,0.8) 19.6%, rgba(206,162,255,0.8) 50%, rgba(255,133,177,0.8) 86%)",
                display: "flex",
                alignItems: "center",
            ...
            >
              <span>Спросите Комильфо о процедуре…</span>
              <span style={{ opacity: 0.9 }}>◍ ◌ ◍</span>
            </div>
          </div>

          {/* Section container with 3-column review grid */}
          <div
            style={{
              marginTop: 80,
              background: "#ffffff",
          ...
          >
            ...
            >
              {[
                {
                  title: "Наконец-то нашла своего врача",
                  body: "Внимательный подход, всё объяснили, никакого давления. Результат естественный.",
                },
                {
                  title: "Чувствую себя увереннее",
                  body: "Программа подобрана лично под меня. Спустя три месяца — заметный эффект.",
                },
                {
                  title: "Медицинский, а не салонный подход",
                  body: "Сертифицированные препараты, документы на каждой процедуре. Спокойно за здоровье.",
                },
              ].map((r, i) => (
                <div
                  key={i}
                ...
                >
                  ...
                  >
                    <div style={{ color: "#00bb76", fontSize: 14, letterSpacing: 2 }}>
                      ★★★★★
                    </div>
                    <div
                      style={{
