...
import specSkachkova from "@/assets/specialist-skachkova.png.asset.json";
...
const specialists: Specialist[] = [
  {
    ...
    focus: "Главный врач центра, врач-косметолог, специалист по лазерным технологиям, инъекционным методикам, методике плазмолифтинга, озонотерапевт.",
    about: "",
    education: "",
