...
import serviceVrachebnaya from "@/assets/optimized/service-vrachebnaya.webp.asset.json";
import serviceMassage from "@/assets/optimized/service-massage.webp.asset.json";
...
const scheduleRows: ScheduleRow[] = [
  { name: "Журавлева Евгения Владимировна", role: "Главный врач, врач-косметолог", room: "1", hours: ["пн: 09:00–21:00", "вт: 09:00–21:00", "чт: 09:00–21:00", "сб: 10:00–18:00*"] },
  { name: "Мамонтова Марина Александровна", role: "Врач-косметолог, врач-дерматовенеролог", room: "2", hours: ["вт: 09:00–21:00", "ср: 09:00–21:00", "пт: 09:00–21:00", "сб: 10:00–18:00*"] },
  ...
  { name: "Дармина Марина Николаевна", role: "Медицинская сестра", room: "3", hours: ["Сменный график 2/2*"] },
];
...
const educationEntries: EducationEntry[] = [
  {
    ...
    items: [
      ...
      { stage: "Профессиональная переподготовка", place: "ГУВППО «Воронежская государственная медицинская академия им. Н.Н. Бурденко», 2003 г.", specialty: "Дерматовенерология", qualification: "Врач-дерматовенеролог" },
      { stage: "Профессиональная переподготовка", place: "ГОУ ВПО «Воронежская государственная медицинская академия имени Н.Н. Бурденко Федерального агентства по здравоохранению и социальному развитию», 2013 г.", specialty: "Косметология", qualification: "Врач-косметолог", certificate: "Косметология до 22.04.2030 г." },
      { stage: "Профессиональная переподготовка", place: "ГОУ ВПО «Воронежская государственная медицинская академия имени Н.Н. Бурденко Федерального агентства по здравоохранению и социальному развитию», 2017 г.", specialty: "Организация здравоохранения и общественное здоровье", qualification: "—", certificate: "Организация здравоохранения и общественное здоровье до 15.05.2031 г." },
    ],
  },
  {
    ...
    items: [
      { stage: "Высшее", place: "ГОУ ВПО «Воронежская государственная медицинская академия имени Н.Н. Бурденко Федерального агентства по здравоохранению и социальному развитию», 2009 г.", specialty: "Лечебное дело", qualification: "Врач" },
      { stage: "Интернатура", place: "ГОУ ВПО «Воронежская государственная медицинская академия имени Н.Н. Бурденко Федерального агентства по здравоохранению и социальному развитию», 2010 г.", specialty: "Дерматовенерология", qualification: "Врач-дерматовенеролог", certificate: "Дерматовенерология до 25.03.2030 г." },
      { stage: "Профессиональная переподготовка", place: "ФГАОУ ВО «РУДН», 2015 г.", specialty: "Косметология", qualification: "Врач-косметолог", certificate: "Косметология до 22.04.2030 г." },
      { stage: "Профессиональная переподготовка", place: "ООО «ЦСО «ПРОФ-РЕСУРС»», 2019 г.", specialty: "Организация здравоохранения и общественное здоровье", qualification: "Заместитель главного врача", certificate: "Организация здравоохранения и общественное здоровье до 10.02.2031 г." },
    ],
  },
  {
    name: "Дмитриевская Анна Ивановна",
    role: "Медицинская сестра по косметологии",
    items: [
      { stage: "Среднее профессиональное", place: "ГАПОУ «Липецкий медицинский колледж», 2022 г.", specialty: "Сестринское дело", qualification: "Медицинская сестра", certificate: "Сестринское дело до 12.07.2027 г." },
      { stage: "Профессиональная подготовка", place: "АНОО ДПО «Институт профессиональных технологий и сервиса «ФИЗ»», 2023 г.", specialty: "Сестринское дело в косметологии", qualification: "Медицинская сестра по косметологии", certificate: "Сестринское дело в косметологии до 04.04.2030 г." },
    ],
  },
  {
    ...
    items: [
      ...
      { stage: "Профессиональная переподготовка", place: "АНО ДПО «ГК Профи», 2020 г.", specialty: "Сестринское дело в косметологии", qualification: "Медицинская сестра по косметологии", certificate: "Сестринское дело в косметологии до 28.10.2030 г." },
    ],
  },
  {
    name: "Корабельщикова Анна Игоревна",
    role: "Медицинская сестра по косметологии",
    items: [
      ...
      { stage: "Профессиональная переподготовка", place: "ГАП ОУ «Липецкий медицинский колледж», 2019 г.", specialty: "Сестринское дело в косметологии", qualification: "Медицинская сестра по косметологии", certificate: "Сестринское дело в косметологии до 25.06.2029 г." },
    ],
  },
  {
    ...
    role: "Медицинская сестра",
    items: [
      { stage: "Среднее профессиональное", place: "Липецкое медицинское училище Министерства здравоохранения РСФСР, 1983 г.", specialty: "Медицинская сестра", qualification: "Медицинская сестра", certificate: "Сестринское дело до 22.04.2030 г." },
    ],
  },
  {
    name: "Дармина Марина Николаевна",
    role: "Медицинская сестра",
    items: [
      { stage: "Среднее профессиональное", place: "Северо-Осетинское медицинское училище, 1990 г.", specialty: "Медицинская сестра", qualification: "Медицинская сестра", certificate: "Сестринское дело до 28.02.2027 г." },
    ],
  },
];
  ...
  return (
    <div className="bg-neutral-950 text-white">
      ...
      <section className="relative h-screen min-h-screen overflow-hidden">
        ...
        <div className="relative z-10 mx-auto flex h-full min-h-screen max-w-6xl items-center px-6 pt-52 pb-8 md:px-8 md:pb-12 md:pt-24">
          <div className="flex w-full items-center gap-0 md:gap-10">
              ...
              {[
                {
                  us: (
                    <>
                      Используем сертифицированные препараты — их можно проверить через <span className="font-medium" style={{ color: BRAND }}>“Честный знак”</span>.
                    </>
                  ),
                ...
                },
                {
                  ...
                  them: "Дешевые китайские аппараты, которые нельзя использовать в медицине.",
                },
                {
