...
const slides: Slide[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Собираем исчерпывающий анализ и проводим диагностику, защищая от аллергии, шрамов и рубцов.",
      "Применяем только сертифицированные препараты и медицинское оборудование.",
    ],
  ...
  },
  {
    ...
    paragraphs: [
      "Мы официально ставим диагноз и ведём историю болезни.",
