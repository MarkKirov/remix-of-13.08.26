...
const hardwareProcedures: Procedure[] = [
  ...
  },
  {
    ...
    preparations: [],
    subServices: [
      { name: "А22.01.001.001 Ультрафонофорез лекарственный кожи (Безинъекционная мезотерапия) Гель антикупирозный, 1 гр. (на аппарате Futura Pro)", price: "250 ₽" },
      { name: "А22.01.001.001 Ультрафонофорез лекарственный кожи (Безинъекционная мезотерапия) Гель гидратирующий для зрелой кожи, 1 гр.", price: "180 ₽" },
      { name: "А22.01.001.001 Ультрафонофорез лекарственный кожи (Безинъекционная мезотерапия) Гель-концентрат с низкомолекулярной гиалуроновой кислоты, 1 гр.", price: "250 ₽" },
      { name: "А22.01.001.001 Ультрафонофорез лекарственный кожи (Безинъекционная мезотерапия) Гель с БТА-эффектом, 1 гр.", price: "250 ₽" },
      { name: "А22.01.001.001 Ультрафонофорез лекарственный кожи (Безинъекционная мезотерапия) Гель увлажняющий, 1 гр.", price: "180 ₽" },
      { name: "А22.01.001.001 Ультрафонофорез лекарственный кожи (Безинъекционная мезотерапия) лицо", price: "2 600 ₽" },
      { name: "А22.01.001.001 Ультрафонофорез лекарственный кожи (Безинъекционная мезотерапия) лоб", price: "1 400 ₽" },
      { name: "А22.01.001.001 Ультрафонофорез лекарственный кожи (Безинъекционная мезотерапия) нижняя треть лица", price: "2 000 ₽" },
      { name: "А22.01.001.001 Ультрафонофорез лекарственный кожи (Безинъекционная мезотерапия) область вокруг глаз", price: "1 500 ₽" },
      { name: "А22.01.007 Фотодинамическая терапия при заболеваниях кожи, подкожно-жировой клетчатки, придатков кожи (лицо)", price: "1 000 ₽" },
    ],
  },
];
