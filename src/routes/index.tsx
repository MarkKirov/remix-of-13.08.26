...
const medicalProcedures: Procedure[] = [
  ...
  },
  {
    ...
    preparations: [],
    subServices: [
      { name: "А20.30.024.006 Внутривенное капельное введение озонированного физиологического раствора", price: "900 ₽" },
      { name: "А20.30.024.007 Малая аутогемоозонотерапия", price: "600 ₽" },
      { name: "Озонотерапия в косметологии", price: "" },
      { name: "А20.30.024 Озонотерапия — Озоновая липосакция внешней поверхности бедра", price: "700 ₽" },
      { name: "А20.30.024 Озонотерапия — Озоновая липосакция внутренней поверхности бедра", price: "700 ₽" },
      { name: "А20.30.024 Озонотерапия — Озоновая липосакция воротниковой зоны", price: "700 ₽" },
      { name: "А20.30.024 Озонотерапия — Озоновая липосакция голени", price: "700 ₽" },
      { name: "А20.30.024 Озонотерапия — Озоновая липосакция живота", price: "700 ₽" },
      { name: "А20.30.024 Озонотерапия — Озоновая липосакция овала лица", price: "600 ₽" },
      { name: "А20.30.024 Озонотерапия — Озоновая липосакция рук", price: "700 ₽" },
      { name: "А20.30.024 Озонотерапия — Озоновая липосакция ягодиц", price: "700 ₽" },
      { name: "А20.30.024 Озонотерапия — Озоновая терапия волосистой части головы", price: "700 ₽" },
      { name: "А20.30.024 Озонотерапия — Озоновая терапия кожи плеча", price: "500 ₽" },
      { name: "А20.30.024 Озонотерапия — Озоновое лечение кожи спины", price: "900 ₽" },
      { name: "А20.30.024 Озонотерапия — Озоновое лечение растяжек (одна зона)", price: "700 ₽" },
      { name: "А20.30.024 Озонотерапия — Озоновый лифтинг кожи внешней поверхности бедра", price: "700 ₽" },
      { name: "А20.30.024 Озонотерапия — Озоновый лифтинг кожи внутренней поверхности бедра", price: "700 ₽" },
      { name: "А20.30.024 Озонотерапия — Озоновый лифтинг кожи голени", price: "700 ₽" },
      { name: "А20.30.024 Озонотерапия — Озоновый лифтинг кожи лица и шеи", price: "700 ₽" },
      { name: "А20.30.024 Озонотерапия — Озоновый лифтинг кожи рук", price: "700 ₽" },
      { name: "А20.30.024 Озонотерапия — Озоновый лифтинг кожи ягодиц", price: "700 ₽" },
    ],
