...
const hardwareProcedures: Procedure[] = [
  ...
  {
    name: "Прочие аппаратные методики",
    price: "по запросу",
    detailsLabel: "Методики",
    preparations: [],
    subServices: [
      { name: "Ультрафонофорез лекарственный кожи (Безинъекционная мезотерапия) Гель антикупирозный, 1 гр. (на аппарате Futura Pro)", price: "250 ₽" },
      { name: "Ультрафонофорез лекарственный кожи (Безинъекционная мезотерапия) Гель гидратирующий для зрелой кожи, 1 гр.", price: "180 ₽" },
      { name: "Ультрафонофорез лекарственный кожи (Безинъекционная мезотерапия) Гель-концентрат с низкомолекулярной гиалуроновой кислоты, 1 гр.", price: "250 ₽" },
      { name: "Ультрафонофорез лекарственный кожи (Безинъекционная мезотерапия) Гель с БТА-эффектом, 1 гр.", price: "250 ₽" },
      { name: "Ультрафонофорез лекарственный кожи (Безинъекционная мезотерапия) Гель увлажняющий, 1 гр.", price: "180 ₽" },
      { name: "Ультрафонофорез лекарственный кожи (Безинъекционная мезотерапия) лицо", price: "2 600 ₽" },
      { name: "Ультрафонофорез лекарственный кожи (Безинъекционная мезотерапия) лоб", price: "1 400 ₽" },
      { name: "Ультрафонофорез лекарственный кожи (Безинъекционная мезотерапия) нижняя треть лица", price: "2 000 ₽" },
      { name: "Ультрафонофорез лекарственный кожи (Безинъекционная мезотерапия) область вокруг глаз", price: "1 500 ₽" },
      { name: "Фотодинамическая терапия при заболеваниях кожи, подкожно-жировой клетчатки, придатков кожи (лицо)", price: "1 000 ₽" },
    ],
    note: "Точную цену вы узнаете на первичной консультации — она бесплатна. Наш специалист подберёт подходящую услугу, рассчитает стоимость и определит нужное количество процедур. Не назначайте курс себе самостоятельно — сначала проконсультируйтесь, и мы составим ваш персональный план создания естественной красоты.",
  },
...
const estheticProcedures: Procedure[] = [
  {
    ...
    preparations: [],
    subServices: [
      { name: "Аппаратные пилинги — Ультразвуковой пилинг (ультразвуковая чистка лица в подготовительном этапе к любой программе по уходу за кожей лица)", price: "950 ₽" },
      { name: "Химический пилинг Dermatime 5n RRT 1 сеанс, Испания", price: "950 ₽" },
      { name: "Химический пилинг Dermatime Argilactic A, Испания", price: "2 450 ₽" },
      { name: "Химический пилинг Dermatime Azelaic A15 раствор, Испания", price: "2 450 ₽" },
      { name: "Химический пилинг Dermatime Azelaic A20 гель, Испания", price: "2 450 ₽" },
      { name: "Химический пилинг Dermatime Ferulic A12 раствор", price: "3 250 ₽" },
      { name: "Химический пилинг JM Peel осветляющий пилинг, Испания", price: "3 000 ₽" },
      { name: "Химический пилинг Dermatime Lactic A80, Испания", price: "2 450 ₽" },
      { name: "Химический пилинг Dermatime Mandelic A40 гель, Испания", price: "3 000 ₽" },
      { name: "Химический пилинг Dermatime Mandelic A40 комбинированный, Испания", price: "3 580 ₽" },
      { name: "Химический пилинг Dermatime Mandelic A40 раствор, Испания", price: "2 900 ₽" },
      { name: "Химический пилинг Dermatime Peruvic A40 раствор, Испания", price: "3 200 ₽" },
      { name: "Химический пилинг Mediderma ANTI-AKNE, Испания", price: "3 400 ₽" },
      { name: "Химический пилинг Mediderma MELASPEEL R, Испания", price: "2 900 ₽" },
      { name: "Химический пилинг Mediderma RETISES CT YELLOW PEEL (жёлтый), Испания", price: "5 250 ₽" },
      { name: "Химический пилинг Mediderma SALIPEEL PLUS (гелевый), Испания", price: "2 900 ₽" },
      { name: "Химический пилинг Mediderma SALIPEEL DS (водно-спиртовой), Испания", price: "2 900 ₽" },
      { name: "Химический пилинг Mediderma Крем RETINOL RETISES 1%, Испания", price: "950 ₽" },
      { name: "Химический пилинг TMC3+ACTION (lite)", price: "6 500 ₽" },
      { name: "Химический пилинг TMC3+ACTION (medium)", price: "8 700 ₽" },
      { name: "Химический пилинг TMC3+ACTION (strong)", price: "11 150 ₽" },
      { name: "Химический пилинг биоревитализант BIOR5 Harmony Castle (Италия)", price: "5 000 ₽" },
      { name: 'Химический пилинг "ЗОЛУШКА" BIOT+ISecret Harmony Castle (Италия)', price: "5 000 ₽" },
      { name: "Химический пилинг иллюминизер BIOT 2 Harmony Castle (Италия)", price: "5 000 ₽" },
      { name: "Химический пилинг интимный омолаживающий и осветляющий ISecret Harmony Castle (Италия)", price: "3 850 ₽" },
      { name: "Химический пилинг осветляющая программа-пилинг MELP3 Harmony Castle (Италия)", price: "5 500 ₽" },
      { name: "Химический пилинг перед биоревитализацией BIOR5 Harmony Castle (Италия)", price: "2 750 ₽" },
      { name: "Химический пилинг периорбитальный омолаживающий и осветляющий ISecret Harmony Castle (Италия)", price: "2 750 ₽" },
      { name: "Химический пилинг ретиноловый Dermatime GOLDEN YELLOW PEEL", price: "5 450 ₽" },
      { name: "Химический пилинг с гликолевой кислотой GLICO C-20, Испания", price: "4 100 ₽" },
  ...
  },
  {
    ...
    subServices: [
      ...
      { name: 'Комплексная программа ухода Academie — "Кислородно-стимулирующая процедура"', price: "7 650 ₽" },
      { name: 'Комплексная программа ухода Academie — "Оптимальное увлажнение"', price: "7 150 ₽" },
      { name: 'Комплексная программа ухода Academie — "Процедура PRO-AGE"', price: "9 900 ₽" },
      { name: 'Комплексная программа ухода Academie — "Процедура против покраснений для чувствительной кожи"', price: "11 800 ₽" },
    ],
    note: "Точную цену вы узнаете на первичной консультации — она бесплатна. Наш специалист подберёт подходящую услугу, рассчитает стоимость и определит нужное количество процедур. Не назначайте курс себе самостоятельно — сначала проконсультируйтесь, и мы составим ваш персональный план создания естественной красоты.",
  },
];
