    ...
    <div className="group">
      ...
      {open && (
        <button
          ...
          className="relative z-10 mx-auto mb-1 mt-2 flex items-center gap-1.5 rounded-full px-3 py-1.5 font-caption text-[10px] uppercase tracking-[0.14em] text-neutral-500 transition-colors hover:text-neutral-900"
        >
