...
const slides: Slide[] = [
  ...
  },
  {
    title: (
      <>
        <span style={{ color: BRAND }}>Чистая медицина и абсолютная безопасность</span>{"\n"}
        вместо подвальных рисков
      </>
    ),
    paragraphs: [
                    ...
                    <div className="pb-6 md:pb-8">
                      ...
                      <ul className="mt-6 max-w-2xl space-y-3 md:mt-8 md:space-y-4">
                        {s.paragraphs.map((p, j) => (
                          <li key={j} className="font-body flex gap-4 text-sm font-light leading-relaxed text-white/90 md:text-base">
                            <span
                              aria-hidden
